export const links = [
  {
    ...
    sublinks: [
      {
        Head: "Building and construction",
        sublink: [
          ...
          { name: "we build on credits", link: "/services" },
        ],
      },
      {
        Head: "Real Estate Listing",
        sublink: [
          { name: "list your properties", link: "/" },
          { name: "for sale", link: "/" },
          { name: "for rent", link: "/" },
          { name: "hostels", link: "/" },
          { name: "air bnb", link: "/" },
      ...
      },
      {
        Head: "Sale of land",
        sublink: [
          { name: "(Locations: GA EAST municipality)", link: "#" },
          { name: "Agbezo", link: "/services" },
          { name: "Akoteaku", link: "/services" },
          { name: "Obakra", link: "/services" },
          { name: "we sell lands on credits", link: "/services" },
        ],
      },
    ],
  },
