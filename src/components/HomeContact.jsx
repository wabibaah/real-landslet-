...
function HomeContact() {
  ...
  const { email, fname, message, pnumber, locat } = formData;
  const formDataCopy = {
    email,
    fname,
    message,
  ...
  function handleSubmit(e) {
    ...
    if (false) {
      ...
      addDoc(contactCollectionRef, formDataCopy)
        .then(() => {
        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-4">
            ...
            >
              ...
              <span class="mt-2">whatsapp us</span>
            </a>
            <a
              href=""
              class="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-300 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500"
            ...
            >
              ...
              <span class="mt-2">+233244639729</span>
            </a>
            ...
            >
              ...
              <span class="mt-2 text-sm">example@example.com</span>
            </a>
          </div>
          ...
          <div class="mt-6 ">
            <form onSubmit={handleSubmit}>
              ...
              <div class="items-center -mx-2 mt-4 md:flex">
                <div class="w-full mx-2">
                  <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">
                    Phone Number
                  </label>
              ...
              <div class="flex justify-center mt-6">
                <button
                  type="submit"
                  class="px-4 py-2 text-white transition-colors duration-300 transform bg-teal-400 rounded-md hover:bg-teal-500 focus:outline-none focus:bg-teal-500 "
                >
                  Send Us Message
                </button>
              </div>
